...
//        return $this->hasMany(VechMed::class, ['id_med' => 'id_med']);
    ...
    public function uploadImage()
    {
        if ($this->upload) { // только если был выбран файл для загрузки
            ...
            if ($this->upload->saveAs($source)) {
                ...
                Image::thumbnail($source, 350, 250)->save($thumb, ['quality' => 90]);
                return $name;
            }
        }
        return false;
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        NaznMed::deleteAll(['id_nazn' => $arr, 'id_med' => $this->id_med]);
        ProtMed::deleteAll(['id_prot' => $arrpr, 'id_med' => $this->id_med]);
        VechMed::deleteAll(['id_v' => $arrv, 'id_med' => $this->id_med]);
    }
}
